error id: file://<WORKSPACE>/src/main/akka-actor/tests/test.scala:[8..8) in Input.VirtualFile("file://<WORKSPACE>/src/main/akka-actor/tests/test.scala", "object 
")
file://<WORKSPACE>/file:<WORKSPACE>/src/main/akka-actor/tests/test.scala
file://<WORKSPACE>/src/main/akka-actor/tests/test.scala:2: error: expected identifier; obtained eof
